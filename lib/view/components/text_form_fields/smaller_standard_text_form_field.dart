...
class SmallerStandardTextFormField extends StatefulWidget {
  TextFormFieldInput textFormFieldInput;
  TextEditingController controller;

  SmallerStandardTextFormField({super.key, required this.textFormFieldInput, required this.controller});

  @override
  State<SmallerStandardTextFormField> createState() => _SmallerStandardTextFormFieldState();
}

class _SmallerStandardTextFormFieldState extends State<SmallerStandardTextFormField> {
